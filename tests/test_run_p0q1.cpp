...
#define NSWP 1000 // number of sweeps in-between measurements
...
int main()
{
    ...
    // scale tuning
    scale = metropolis_scale_tuning(action_p0q1, action_diff_p0q1, G2, scale, TGTAR, NDA, eigvals, N, gen);
    cout << "tuned scale: " << scale << endl;

    // thermalization
    double ar_th = metropolis(action_p0q1, action_diff_p0q1, G2, scale, NTH, eigvals, N, gen);
    ...
    {
        ar += metropolis(action_p0q1, action_diff_p0q1, G2, scale, NSWP, eigvals, N, gen);
